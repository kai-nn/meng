...
class Tech(db.Model):
    ...
    creater = db.Column(db.String(60))
    approving = db.Column(db.String(60))
    checking = db.Column(db.String(60))
    m_expertise = db.Column(db.String(60))
    n_control = db.Column(db.String(60))
    agreement = db.Column(db.Text)
